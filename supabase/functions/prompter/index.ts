...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  #trilho p.cue {
    color: #e0a63c; font-weight: 400; font-style: italic;
    opacity: .85; font-size: .62em;
  }
  body.claro #trilho p.cue { color: #8a5d10; }
  ...
  .anel { width: 62px; height: 62px; border-radius: 50%; border: 2px solid #123; border-top-color: #4ca8dd; animation: girar 1.1s linear infinite; }
  @keyframes girar { to { transform: rotate(360deg); } }
  #espera h1 { font-size: 15px; font-weight: 600; letter-spacing: .22em; margin: 0; color: #9fb6d4; }
  #espera p { font-size: 13px; color: #6b7fa8; margin: 0; max-width: 30ch; line-height: 1.6; }
  ...
  #barra {
    ...
    color: #6b7fa8; background: linear-gradient(#000c, transparent);
    transition: opacity .4s; font-family: ui-monospace, monospace;
  }
  #barra.sumiu { opacity: 0; }
  body.claro #barra { color: #6b7fa8; background: linear-gradient(#fffc, transparent); }
  .luz { display: inline-block; width: 7px; height: 7px; border-radius: 50%; background: #f0576b; margin-right: 6px; }
  .luz.on { background: #35c39a; }
