...
<meta name="theme-color" content="#141f27">
...
<style>
  ...
  * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
  ...
  #trilho p.cue {
    color: #d3a35f; font-weight: 400; font-style: italic;
    opacity: .85; font-size: .62em;
  }
  body.claro #trilho p.cue { color: #8a6220; }
  ...
  .anel { width: 62px; height: 62px; border-radius: 50%; border: 2px solid #123; border-top-color: #bcceda; animation: girar 1.1s linear infinite; }
  @keyframes girar { to { transform: rotate(360deg); } }
  #espera h1 { font-size: 15px; font-weight: 600; letter-spacing: .22em; margin: 0; color: #a8bbc9; }
  #espera p { font-size: 13px; color: #6e8093; margin: 0; max-width: 30ch; line-height: 1.6; }
  ...
  #barra {
    ...
    color: #6e8093; background: linear-gradient(#000c, transparent);
    transition: opacity .4s; font-family: ui-monospace, monospace;
  }
  #barra.sumiu { opacity: 0; }
  body.claro #barra { color: #6e8093; background: linear-gradient(#fffc, transparent); }
  .luz { display: inline-block; width: 7px; height: 7px; border-radius: 50%; background: #d3736b; margin-right: 6px; }
  .luz.on { background: #6fae8f; }
